        ...
        <Container style={{paddingTop:"60px", marginBottom:"10px"}}>
            <Row>
                <Col md={5} className="d-flex justify-content-center align-items-center">
                    <div>
                        <p>
                        "Come on, let's practice together now! Follow this intervention for 14 days. Every day, practice Activity Therapy and check your experience on the daily checklist beside!" </p>                        <img src={checklistImage} alt="Intervensi Cemas" className="img-fluid" style={{ maxWidth: '250px' }} />
                    </div>
                </Col>
                <Col md={7}>
