...
const MBSR3 = () => {
  ...
  const quotes = [
    "Amazing! Every bite you take brings you peace.",
"Great! You have found happiness in every bite of your food.",
"Very good! Today you have enjoyed every taste mindfully.",
"Awesome! Mindful eating helps reduce your burden on your mind.",
"Every small bite you take brings you happiness.",
"Keep eating mindfully. Every bite is a step towards peace.",
"You are great! Today you have felt peace in every bite of your food."
  ];
      ...
      <Container>
        <div className="container text-center" style={{ marginTop: "10px" }}>
          <h6 className="section-title mb-2" style={{ color: "#EBBCBC", fontWeight: "bold", fontSize: "35px" }}>
            <br />Welcome to the third week !<br />Let's Practice Mindfulness Eating<br />
          </h6>
        </div>
