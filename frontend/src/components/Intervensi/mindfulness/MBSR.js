    ...
    const fetchDailyStatuses = async () => {
      ...
      try {
        ...
        dailyStatuses.forEach(status => {
          ...
          if (status.intervention_week === '1' && day >= 1 && day <= 7) {
      ...
      <Container>
        <div className="container text-center" style={{ marginTop: "10px" }}>
          <h6 className="section-title mb-2" style={{ color: "#EBBCBC", fontWeight: "bold", fontSize: "35px" }}>
            <br />Welcome to the first week !<br />Let's Do Meditation Exercises<br />
          </h6>
        </div>
            ...
            <Card className="about-us-card" style={{ backgroundColor: "#EBBCBC", marginTop: "50px" }}>
              <Card.Body>
                ...
                <p style={{ fontSize: "16px" }}>
                  <br></br>
                  Here is a short meditation exercise you can do at home:<br></br>
1. Sit comfortably in a chair or on the floor with your back straight.<br></br>
2. Close your eyes or look down.<br></br>
3. Focus your attention on your breathing. Feel the sensation of the breath coming in and out of your nose.<br></br>
4. If your mind wanders, gently bring your attention back to your breathing.<br></br>
5. Follow the meditation flow below.
                </p>
              </Card.Body>
            </Card>
          </Col>
      ...
      <section className="section before-content" style={{ color: "#141313", marginTop: "5px", paddingTop: "10px", paddingBottom: "100px" }}>
        <Container>
          <h6 className="mb-4 tfonts-2 text-center" style={{ color: "white" }}>Mindfulness Walking Practice</h6>
          <Row>
            <Col md={5} className="d-flex align-items-center justify-content-center" style={{ marginLeft: "130px", marginTop: "50px" }}>
              <div className="text-center">
                <video src={week1} controls style={{ width: "100%", height: "auto" }} />
              </div>
            </Col>
            <Col md={5}>
              <h6 className="mb-4" style={{ marginLeft: "50px", marginTop: "50px" }}>
              "Come on, let's practice now! Follow this intervention for 7 days. Every day, practice the Short Meditation and check your experience on the daily checklist below!"              </h6>
