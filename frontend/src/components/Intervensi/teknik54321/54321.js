        ...
        <Container style={{paddingTop:"20px", marginBottom:"100px"}}>
            <Row>
                <Col md={5} className="d-flex justify-content-center align-items-center">
                    <div>
                        <p>
                        "Come on, let's practice together now! Follow this intervention for 14 days. Every day, practice the '5-4-3-2-1' technique and check your experience on the daily checklist beside!"                        </p>
                ...
                <Col md={7}>
                    <Card className="text-center" style={{backgroundColor:"#C5C0FC"}}>
                        <Card.Body style={{marginBottom:"50px"}}>
                            <Card.Title className="mb-3" style={{marginBottom:"50px",color:"white"}}>Daily Checklist</Card.Title>
